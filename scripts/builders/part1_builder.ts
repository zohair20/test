...
export function buildPart1Questions(): Question[] {
  const qList: Omit<Question, 'id' | 'part'>[] = [
    ...
    },
    {
      ...
      choices: ["Couche 2 — Liaison de données", "Couche 3 — Réseau", "Couche 4 — Transport", "Couche 5 — Session"],
      options: ["Couche 2 — Liaison de données", "Couche 3 — Réseau", "Couche 4 — Transport", "Couche 5 — Session"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Couche Transport", "Couche Application", "Couche Internet", "Couche Accès Réseau"],
      options: ["Couche Transport", "Couche Application", "Couche Internet", "Couche Accès Réseau"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Trame (Frame)", "Paquet (Packet)", "Segment", "Bit"],
      options: ["Trame (Frame)", "Paquet (Packet)", "Segment", "Bit"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["Couche Session", "Couche Présentation", "Couche Application", "Couche Liaison"],
      options: ["Couche Session", "Couche Présentation", "Couche Application", "Couche Liaison"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Désencapsulation", "Encapsulation", "Multiplexage", "Fragmentation"],
      options: ["Désencapsulation", "Encapsulation", "Multiplexage", "Fragmentation"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Couche Physique (Couche 1)", "Couche Liaison de données (Couche 2)", "Couche Réseau (Couche 3)", "Couche Transport (Couche 4)"],
      options: ["Couche Physique (Couche 1)", "Couche Liaison de données (Couche 2)", "Couche Réseau (Couche 3)", "Couche Transport (Couche 4)"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["LLC (Logical Link Control)", "MAC (Media Access Control)", "PHY (Physical)", "IP (Internet Protocol)"],
    ...
    },
    {
      ...
      choices: ["Le routeur", "La passerelle applicative", "Le concentrateur (Hub)", "Le commutateur (Switch)"],
      options: ["Le routeur", "La passerelle applicative", "Le concentrateur (Hub)", "Le commutateur (Switch)"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["Couche Transport", "Couche Session", "Couche Réseau", "Couche Application"],
      options: ["Couche Transport", "Couche Session", "Couche Réseau", "Couche Application"],
      correctAnswer: 1,
    ...
    // 2. IPv4 & IPv6 (11-20)
    {
      ...
      choices: ["32 bits et 64 bits", "32 bits et 128 bits", "64 bits et 128 bits", "128 bits et 256 bits"],
      options: ["32 bits et 64 bits", "32 bits et 128 bits", "64 bits et 128 bits", "128 bits et 256 bits"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["1.0.0.0 à 126.255.255.255", "128.0.0.0 à 191.255.255.255", "192.0.0.0 à 223.255.255.255", "224.0.0.0 à 239.255.255.255"],
      options: ["1.0.0.0 à 126.255.255.255", "128.0.0.0 à 191.255.255.255", "192.0.0.0 à 223.255.255.255", "224.0.0.0 à 239.255.255.255"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["8.8.8.8", "172.20.14.5", "195.154.120.1", "208.67.222.222"],
      options: ["8.8.8.8", "172.20.14.5", "195.154.120.1", "208.67.222.222"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["::1", "127.0.0.1", "fe80::1", "ff02::1"],
      options: ["::1", "127.0.0.1", "fe80::1", "ff02::1"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["fc00::/7", "fe80::/10", "ff00::/8", "2001::/16"],
    ...
    },
    {
      ...
      choices: ["DHCPv6", "NDP (Neighbor Discovery Protocol) avec messages ICMPv6", "SLAAC", "RIPng"],
      options: ["DHCPv6", "NDP (Neighbor Discovery Protocol) avec messages ICMPv6", "SLAAC", "RIPng"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Unicast", "Multicast", "Broadcast (Diffusion générale)", "Anycast"],
      options: ["Unicast", "Multicast", "Broadcast (Diffusion générale)", "Anycast"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["Classe A", "Classe C", "Classe D (Multicast)", "Classe E (Expérimentale)"],
      options: ["Classe A", "Classe C", "Classe D (Multicast)", "Classe E (Expérimentale)"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["Time to Live (TTL)", "Type of Service (ToS)", "Checksum", "Header Length (IHL)"],
      options: ["Time to Live (TTL)", "Type of Service (ToS)", "Checksum", "Header Length (IHL)"],
      correctAnswer: 0,
    ...
    // 3. Adressage IP & Subnetting (21-30)
    {
      ...
      choices: ["256 hôtes", "254 hôtes", "255 hôtes", "128 hôtes"],
      options: ["256 hôtes", "254 hôtes", "255 hôtes", "128 hôtes"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["192.168.10.63", "192.168.10.64", "192.168.10.127", "192.168.10.255"],
    ...
    },
    {
      ...
      choices: ["255.255.255.224", "255.255.255.240", "255.255.255.248", "255.255.255.192"],
      options: ["255.255.255.224", "255.255.255.240", "255.255.255.248", "255.255.255.192"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["172.16.0.0", "172.16.32.0", "172.16.40.0", "172.16.48.0"],
      options: ["172.16.0.0", "172.16.32.0", "172.16.40.0", "172.16.48.0"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["6 sous-réseaux", "8 sous-réseaux", "16 sous-réseaux", "4 sous-réseaux"],
      options: ["6 sous-réseaux", "8 sous-réseaux", "16 sous-réseaux", "4 sous-réseaux"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["OU logique (OR)", "ET logique (AND)", "OU Exclusif (XOR)", "NON logique (NOT)"],
      options: ["OU logique (OR)", "ET logique (AND)", "OU Exclusif (XOR)", "NON logique (NOT)"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["3 bits", "4 bits", "5 bits", "7 bits"],
      options: ["3 bits", "4 bits", "5 bits", "7 bits"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["10.1.1.125", "10.1.1.126", "10.1.1.127", "10.1.1.64"],
      options: ["10.1.1.125", "10.1.1.126", "10.1.1.127", "10.1.1.64"],
      correctAnswer: 1,
    ...
    // 4. Routage & Protocoles de Routage (31-40)
    {
      topic: 'Routage',
      difficulty: 'Moyen',
      question: "Quelle métrique est utilisée par le protocole de routage à vecteur de distance RIP (Routing Information Protocol) ?",
      choices: ["La bande passante", "Le délai de transmission", "Le nombre de sauts (Hop Count)", "Le coût financier"],
      options: ["La bande passante", "Le délai de transmission", "Le nombre de sauts (Hop Count)", "Le coût financier"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["Algorithme de Bellman-Ford", "Algorithme de Dijkstra (SPF)", "Algorithme de Floyd-Warshall", "Algorithme de Kruskal"],
      options: ["Algorithme de Bellman-Ford", "Algorithme de Dijkstra (SPF)", "Algorithme de Floyd-Warshall", "Algorithme de Kruskal"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["OSPF", "EIGRP", "BGP (Border Gateway Protocol)", "IS-IS"],
      options: ["OSPF", "EIGRP", "BGP (Border Gateway Protocol)", "IS-IS"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["127.0.0.1/8", "0.0.0.0/0", "255.255.255.255/32", "192.168.1.1/24"],
      options: ["127.0.0.1/8", "0.0.0.0/0", "255.255.255.255/32", "192.168.1.1/24"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Le coût de lien", "La distance administrative", "Le MTU", "Le TTL"],
      options: ["Le coût de lien", "La distance administrative", "Le MTU", "Le TTL"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Poison Reverse", "Split Horizon", "Route Summarization", "Holddown Timer"],
      options: ["Poison Reverse", "Split Horizon", "Route Summarization", "Holddown Timer"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Zone 1", "Zone 0 (Area 0)", "Zone Stub", "Zone NSSA"],
      options: ["Zone 1", "Zone 0 (Area 0)", "Zone Stub", "Zone NSSA"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["La route avec la plus petite distance administrative", "La route avec le masque de sous-réseau le plus long (Longest Prefix Match)", "La route la plus ancienne", "La première route de la table"],
      options: ["La route avec la plus petite distance administrative", "La route avec le masque de sous-réseau le plus long (Longest Prefix Match)", "La route la plus ancienne", "La première route de la table"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Port UDP 520", "Port TCP 179", "Port IP 89", "Port TCP 80"],
      options: ["Port UDP 520", "Port TCP 179", "Port IP 89", "Port TCP 80"],
      correctAnswer: 1,
    ...
    // 5. Switching, Ethernet & ARP (41-50)
    {
      topic: 'Switching & ARP',
      difficulty: 'Facile',
      question: "Combien d'octets composent une adresse MAC (adresse matérielle Ethernet IEEE 802) ?",
      choices: ["4 octets (32 bits)", "6 octets (48 bits)", "8 octets (64 bits)", "16 octets (128 bits)"],
      options: ["4 octets (32 bits)", "6 octets (48 bits)", "8 octets (64 bits)", "16 octets (128 bits)"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["00:00:00:00:00:00", "FF:FF:FF:FF:FF:FF", "01:00:5E:00:00:01", "FE:80:00:00:00:01"],
      options: ["00:00:00:00:00:00", "FF:FF:FF:FF:FF:FF", "01:00:5E:00:00:01", "FE:80:00:00:00:01"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["STP (Spanning Tree Protocol)", "OSPF", "BGP", "VTP"],
      options: ["STP (Spanning Tree Protocol)", "OSPF", "BGP", "VTP"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Le Designated Port", "Le Root Bridge (Pont Racine)", "Le Backup Bridge", "Le Root Port"],
      options: ["Le Designated Port", "Le Root Bridge (Pont Racine)", "Le Backup Bridge", "Le Root Port"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["SYN Flood", "ARP Poisoning / ARP Spoofing", "Smurf Attack", "DNS Amplification"],
      options: ["SYN Flood", "ARP Poisoning / ARP Spoofing", "Smurf Attack", "DNS Amplification"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["arp -a", "route print", "netstat -r", "ip link"],
      options: ["arp -a", "route print", "netstat -r", "ip link"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["512 octets", "1024 octets", "1500 octets", "9000 octets"],
      options: ["512 octets", "1024 octets", "1500 octets", "9000 octets"],
      correctAnswer: 2,
    ...
    // 6. VLAN & NAT (51-60)
    {
      ...
      choices: ["IEEE 802.1D", "IEEE 802.1Q", "IEEE 802.3", "IEEE 802.11"],
      options: ["IEEE 802.1D", "IEEE 802.1Q", "IEEE 802.3", "IEEE 802.11"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["Un concentrateur (Hub)", "Un commutateur de niveau 2 non-manageable", "Un équipement de niveau 3 (Routeur ou Switch L3)", "Un serveur DHCP"],
      options: ["Un concentrateur (Hub)", "Un commutateur de niveau 2 non-manageable", "Un équipement de niveau 3 (Routeur ou Switch L3)", "Un serveur DHCP"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["NAT Statique", "NAT Dynamique sans surcharge", "PAT (Port Address Translation) / NAT Overload", "NAT 1:1"],
      options: ["NAT Statique", "NAT Dynamique sans surcharge", "PAT (Port Address Translation) / NAT Overload", "NAT 1:1"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["Router-on-a-stick", "Dual-homing", "Static routing L1", "Port Mirroring"],
      options: ["Router-on-a-stick", "Dual-homing", "Static routing L1", "Port Mirroring"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["VLAN 0", "VLAN 1", "VLAN 100", "VLAN 4095"],
    ...
    },
    {
      ...
      choices: ["8 bits (256 VLANs)", "12 bits (4096 VLANs)", "16 bits (65536 VLANs)", "24 bits"],
      options: ["8 bits (256 VLANs)", "12 bits (4096 VLANs)", "16 bits (65536 VLANs)", "24 bits"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["NAT Statique (One-to-One)", "NAT Dynamique", "PAT", "Masquerading"],
      options: ["NAT Statique (One-to-One)", "NAT Dynamique", "PAT", "Masquerading"],
      correctAnswer: 0,
    ...
    // 7. TCP, UDP & Protocoles de Transport (61-70)
    {
      topic: 'TCP / UDP & Ports',
      difficulty: 'Facile',
    ...
    },
    {
      ...
      choices: ["Le contrôle de congestion", "Le fenêtrage glissant (Window Size / Sliding Window)", "La somme de contrôle (Checksum)", "Le Three-way Handshake"],
      options: ["Le contrôle de congestion", "Le fenêtrage glissant (Window Size / Sliding Window)", "La somme de contrôle (Checksum)", "Le Three-way Handshake"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["80 et 8080", "80 et 443", "443 et 8443", "25 et 110"],
      options: ["80 et 8080", "80 et 443", "443 et 8443", "25 et 110"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["FIN", "SYN", "RST (Reset)", "URG"],
      options: ["FIN", "SYN", "RST (Reset)", "URG"],
      correctAnswer: 2,
    ...
    },
    {
      ...
      choices: ["Algorithme de Nagle", "Algorithme de Jacobson (Slow Start et Congestion Avoidance)", "Algorithme de Dijkstra", "Algorithme de Token Bucket"],
      options: ["Algorithme de Nagle", "Algorithme de Jacobson (Slow Start et Congestion Avoidance)", "Algorithme de Dijkstra", "Algorithme de Token Bucket"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["DNS", "FTP", "SMTP", "BGP"],
      options: ["DNS", "FTP", "SMTP", "BGP"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["0 à 1023", "1024 à 49151", "49152 à 65535", "1 à 255"],
      options: ["0 à 1023", "1024 à 49151", "49152 à 65535", "1 à 255"],
      correctAnswer: 0,
    ...
    // 8. DHCP, DNS & Services Réseau (71-80)
    {
      topic: 'DHCP & DNS',
      difficulty: 'Facile',
      question: "Quel acronyme résume les 4 étapes chronologiques de négociation d'un bail DHCP IPv4 ?",
      choices: ["DORA (Discover, Offer, Request, Acknowledge)", "REST (Request, Establish, Send, Terminate)", "ACID (Alloc, Check, Init, Done)", "PING (Probe, Identify, Negotiate, Grant)"],
      options: ["DORA (Discover, Offer, Request, Acknowledge)", "REST (Request, Establish, Send, Terminate)", "ACID (Alloc, Check, Init, Done)", "PING (Probe, Identify, Negotiate, Grant)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Client UDP 68, Serveur UDP 67", "Client UDP 67, Serveur UDP 68", "Port TCP 53 et 54", "Port UDP 161 et 162"],
      options: ["Client UDP 68, Serveur UDP 67", "Client UDP 67, Serveur UDP 68", "Port TCP 53 et 54", "Port UDP 161 et 162"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Enregistrement A", "Enregistrement AAAA", "Enregistrement CNAME", "Enregistrement MX"],
      options: ["Enregistrement A", "Enregistrement AAAA", "Enregistrement CNAME", "Enregistrement MX"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["CNAME (Canonical Name)", "PTR (Pointer)", "NS (Name Server)", "SOA (Start of Authority)"],
      options: ["CNAME (Canonical Name)", "PTR (Pointer)", "NS (Name Server)", "SOA (Start of Authority)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Enregistrement MX", "Enregistrement TXT", "Enregistrement PTR", "Enregistrement SRV"],
      options: ["Enregistrement MX", "Enregistrement TXT", "Enregistrement PTR", "Enregistrement SRV"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["in-addr.arpa", "ip6.arpa", "root-servers.net", "dns.reversed"],
      options: ["in-addr.arpa", "ip6.arpa", "root-servers.net", "dns.reversed"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["DNSSEC (DNS Security Extensions)", "DoH (DNS over HTTPS)", "DoT (DNS over TLS)", "mDNS"],
      options: ["DNSSEC (DNS Security Extensions)", "DoH (DNS over HTTPS)", "DoT (DNS over TLS)", "mDNS"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Agent de relais DHCP (DHCP Relay / IP Helper-Address)", "Un commutateur L1", "Un proxy HTTP", "Une passerelle NAT"],
      options: ["Agent de relais DHCP (DHCP Relay / IP Helper-Address)", "Un commutateur L1", "Un proxy HTTP", "Une passerelle NAT"],
      correctAnswer: 0,
    ...
    // 9. HTTP / HTTPS & Sécurité Réseau (81-90)
    {
      topic: 'HTTP / HTTPS',
      difficulty: 'Facile',
      question: "Quel code d'état HTTP signale un succès standard de la requête (OK) ?",
      choices: ["200 OK", "201 Created", "301 Moved Permanently", "404 Not Found"],
    ...
    },
    {
      ...
      choices: ["Ressource non trouvée", "Accès interdit (Forbidden)", "Erreur interne du serveur", "Mauvaise requête (Bad Request)"],
      options: ["Ressource non trouvée", "Accès interdit (Forbidden)", "Erreur interne du serveur", "Mauvaise requête (Bad Request)"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["IPsec", "TLS (Transport Layer Security)", "SSH", "Kerberos"],
      options: ["IPsec", "TLS (Transport Layer Security)", "SSH", "Kerberos"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["TCP", "QUIC (au-dessus d'UDP)", "SCTP", "DCCP"],
      options: ["TCP", "QUIC (au-dessus d'UDP)", "SCTP", "DCCP"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      choices: ["WEP", "WPA", "WPA2-PSK", "WPA3-Personal"],
      options: ["WEP", "WPA", "WPA2-PSK", "WPA3-Personal"],
      correctAnswer: 3,
    ...
    },
    {
      ...
      choices: ["Mode Transport", "Mode Tunnel", "Mode AH simple", "Mode Pass-through"],
      options: ["Mode Transport", "Mode Tunnel", "Mode AH simple", "Mode Pass-through"],
      correctAnswer: 1,
    ...
    // 10. Commandes & Diagnostic Réseau (91-100)
    {
      ...
      choices: ["TCP", "UDP", "ICMP (Internet Control Message Protocol)", "IGMP"],
    ...
    },
    {
      ...
      choices: ["ip addr show (ou ip a)", "route -n", "netstat -l", "ping -c"],
      options: ["ip addr show (ou ip a)", "route -n", "netstat -l", "ping -c"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["netstat -tuln", "netstat -a", "netstat -r", "netstat -s"],
      options: ["netstat -tuln", "netstat -a", "netstat -r", "netstat -s"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["dig (Domain Information Groper)", "curl", "nmap", "tcpdump"],
      options: ["dig (Domain Information Groper)", "curl", "nmap", "tcpdump"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["tcpdump", "iptables", "ethtool", "dhclient"],
      options: ["tcpdump", "iptables", "ethtool", "dhclient"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["ipconfig /flushdns", "ipconfig /release", "ipconfig /renew", "netsh reset"],
      options: ["ipconfig /flushdns", "ipconfig /release", "ipconfig /renew", "netsh reset"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Nmap (Network Mapper)", "Putty", "FileZilla", "Cisco Packet Tracer"],
      options: ["Nmap (Network Mapper)", "Putty", "FileZilla", "Cisco Packet Tracer"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["ip route show (ou route -n)", "arp -n", "iptables -L", "systemctl status network"],
      options: ["ip route show (ou route -n)", "arp -n", "iptables -L", "systemctl status network"],
      correctAnswer: 0,
    ...
    },
    {
      topic: 'Configuration réseau',
      difficulty: 'Moyen',
      question: "Quel protocole réseau sécurisé de transfert de fichiers s'exécute comme sous-système au-dessus d'une session SSH chiffrée sur le port 22 ?",
      choices: ["SFTP (SSH File Transfer Protocol)", "FTPS (FTP over SSL)", "TFTP", "Telnet"],
      options: ["SFTP (SSH File Transfer Protocol)", "FTPS (FTP over SSL)", "TFTP", "Telnet"],
      correctAnswer: 0,
      explanation: "SFTP (SSH File Transfer Protocol) utilise une connexion SSH unique sur le port 22 pour sécuriser l'authentification et les transferts de fichiers.",
      source: "Ancien examen"
    }
  ];
