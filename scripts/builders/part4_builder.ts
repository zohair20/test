...
export function buildPart4Questions(): Question[] {
  const qList: Omit<Question, 'id' | 'part'>[] = [
    // 1. Concepts fondamentaux POO (1-10)
    {
      topic: 'Concepts POO',
      difficulty: 'Facile',
    ...
    },
    {
      ...
      choices: ["L'Encapsulation", "L'Héritage", "Le Polymorphisme", "La Généricité"],
      options: ["L'Encapsulation", "L'Héritage", "Le Polymorphisme", "La Généricité"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["java.lang.Object", "java.lang.Class", "java.lang.System", "java.lang.Root"],
      options: ["java.lang.Object", "java.lang.Class", "java.lang.System", "java.lang.Root"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["new", "create", "alloc", "init"],
      options: ["new", "create", "alloc", "init"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["@Override", "@Inherit", "@Redefine", "@Overwrite"],
      options: ["@Override", "@Inherit", "@Redefine", "@Overwrite"],
      correctAnswer: 0,
    ...
    // 2. Classes, Objets, Constructeurs & 'this' (11-20)
    {
    ...
    },
    {
      ...
      choices: ["private", "protected", "public", "package-private (par défaut)"],
      options: ["private", "protected", "public", "package-private (par défaut)"],
      correctAnswer: 0,
    ...
    // 3. Mots-clés Java (static, final, super, instanceof) (21-30)
    {
    ...
    },
    {
      ...
      choices: ["import static", "using static", "include static", "static import"],
      options: ["import static", "using static", "include static", "static import"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["transient", "volatile", "static", "noserialize"],
      options: ["transient", "volatile", "static", "noserialize"],
      correctAnswer: 0,
    ...
    // 4. Interfaces, Classes abstraites (31-40)
    {
    ...
    },
    {
      ...
      choices: ["default", "concrete", "static", "standard"],
      options: ["default", "concrete", "static", "standard"],
      correctAnswer: 0,
    ...
    // 5. Gestion des exceptions (41-50)
    {
      topic: 'Exceptions Java',
      difficulty: 'Facile',
      question: "Quelle est la classe racine de toutes les erreurs et exceptions dans la hiérarchie Java ?",
      choices: ["java.lang.Throwable", "java.lang.Exception", "java.lang.Error", "java.lang.RuntimeException"],
      options: ["java.lang.Throwable", "java.lang.Exception", "java.lang.Error", "java.lang.RuntimeException"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Le Try-with-resources", "Le AutoClose catch", "Le resource cleaner", "Le safe try"],
      options: ["Le Try-with-resources", "Le AutoClose catch", "Le resource cleaner", "Le safe try"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["NullPointerException", "IllegalArgumentException", "ClassCastException", "IllegalStateException"],
      options: ["NullPointerException", "IllegalArgumentException", "ClassCastException", "IllegalStateException"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["printStackTrace()", "printTrace()", "dumpStack()", "showError()"],
      options: ["printStackTrace()", "printTrace()", "dumpStack()", "showError()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["OutOfMemoryError", "FileNotFoundException", "ArithmeticException", "NullPointerException"],
      options: ["OutOfMemoryError", "FileNotFoundException", "ArithmeticException", "NullPointerException"],
      correctAnswer: 0,
    ...
    // 6. Java Collections Framework (51-60)
    {
      ...
      choices: ["java.util.Collection", "java.util.List", "java.util.Iterable", "java.util.Set"],
      options: ["java.util.Collection", "java.util.List", "java.util.Iterable", "java.util.Set"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["HashSet", "ArrayList", "LinkedList", "Vector"],
    ...
    },
    {
      ...
      choices: ["java.util.Map", "java.util.Dictionary", "java.util.Pair", "java.util.Table"],
      options: ["java.util.Map", "java.util.Dictionary", "java.util.Pair", "java.util.Table"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["TreeMap", "HashMap", "LinkedHashMap", "ConcurrentHashMap"],
      options: ["TreeMap", "HashMap", "LinkedHashMap", "ConcurrentHashMap"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["O(1) temps constant", "O(log n)", "O(n)", "O(n^2)"],
      options: ["O(1) temps constant", "O(log n)", "O(n)", "O(n^2)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Collections.sort(liste)", "Collections.order(liste)", "liste.arrange()", "Arrays.sortList(liste)"],
      options: ["Collections.sort(liste)", "Collections.order(liste)", "liste.arrange()", "Arrays.sortList(liste)"],
      correctAnswer: 0,
    ...
    // 7. Généricité & Types paramétrés (61-70)
    {
    ...
    },
    {
      ...
      choices: ["Autoboxing et Unboxing", "Casting dynamique", "Marshaling", "Polymorphisme primitif"],
      options: ["Autoboxing et Unboxing", "Casting dynamique", "Marshaling", "Polymorphisme primitif"],
      correctAnswer: 0,
    ...
    // 8. Streams API & Lambdas (71-80)
    {
      ...
      choices: ["x -> x * x", "lambda(x) { x * x }", "x => x * x", "(x) :: (x * x)"],
      options: ["x -> x * x", "lambda(x) { x * x }", "x => x * x", "(x) :: (x * x)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["map()", "filter()", "distinct()", "peek()"],
      options: ["map()", "filter()", "distinct()", "peek()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["filter()", "select()", "where()", "match()"],
      options: ["filter()", "select()", "where()", "match()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Predicate<T>", "Function<T, R>", "Consumer<T>", "Supplier<T>"],
    ...
    },
    {
      ...
      choices: ["Consumer<T>", "Supplier<T>", "Function<T, R>", "Runnable"],
      options: ["Consumer<T>", "Supplier<T>", "Function<T, R>", "Runnable"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["java.util.Optional<T>", "java.util.Nullable<T>", "java.util.Maybe<T>", "java.util.Option<T>"],
      options: ["java.util.Optional<T>", "java.util.Nullable<T>", "java.util.Maybe<T>", "java.util.Option<T>"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["liste.parallelStream()", "liste.concurrentStream()", "liste.asyncStream()", "liste.threadStream()"],
      options: ["liste.parallelStream()", "liste.concurrentStream()", "liste.asyncStream()", "liste.threadStream()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["String::valueOf", "String.valueOf", "String->valueOf", "String::new"],
      options: ["String::valueOf", "String.valueOf", "String->valueOf", "String::new"],
      correctAnswer: 0,
      explanation: "L'opérateur de référence de méthode utilise quatre points `::` : `Classe::nomMethode`.",
      source: "Ancien examen"
    },

    // 9. Multithreading & Concurrence (81-90)
    {
    ...
    },
    {
      ...
      choices: ["start()", "run()", "execute()", "launch()"],
    ...
    },
    {
      ...
      choices: ["AtomicInteger", "VolatileInteger", "SynchronizedInteger", "ConcurrentInteger"],
      options: ["AtomicInteger", "VolatileInteger", "SynchronizedInteger", "ConcurrentInteger"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["ExecutorService (via Executors)", "ThreadFactory manual", "ProcessBuilder", "ThreadGroup"],
      options: ["ExecutorService (via Executors)", "ThreadFactory manual", "ProcessBuilder", "ThreadGroup"],
      correctAnswer: 0,
    ...
    // 10. JVM, Garbage Collection & Mémoire (91-100)
    {
      topic: 'JVM & Garbage Collection',
      difficulty: 'Facile',
      question: "Que signifie le sigle JVM ?",
      choices: ["Java Virtual Machine", "Java Variable Manager", "Java Verified Memory", "Java Version Monitor"],
      options: ["Java Virtual Machine", "Java Variable Manager", "Java Verified Memory", "Java Version Monitor"],
      correctAnswer: 0,
    ...
    },
    {
      topic: 'JVM & Garbage Collection',
      difficulty: 'Moyen',
      question: "Quelle zone de mémoire de la JVM (qui a remplacé l'ancien PermGen depuis Java 8) stocke les métadonnées de classes en dehors du tas Java, dans la mémoire native de l'OS ?",
      choices: ["Metaspace", "Native Heap", "Code Cache", "Direct Buffer"],
      options: ["Metaspace", "Native Heap", "Code Cache", "Direct Buffer"],
      correctAnswer: 0,
      explanation: "Le Metaspace stocke les définitions de classes dans la mémoire native du système d'exploitation et s'auto-redimensionne dynamiquement par défaut.",
      source: "Ancien examen"
    },
    {
      topic: 'JVM & Garbage Collection',
      difficulty: 'Difficile',
      question: "Qu'est-ce qui peut constituer une racine de Garbage Collection (GC Root) ?",
      choices: [
        "Les variables locales sur la pile d'exécution d'un thread, les paramètres actifs, les variables statiques de classes chargées, et les références JNI",
        "N'importe quel objet créé avec new",
      ...
      correctAnswer: 0,
      explanation: "Les GC Roots sont les points de départ du graphe d'accessibilité. Tout objet non atteignable par transitivité depuis une racine GC Root est éligible à la collecte.",
      source: "Ancien examen"
    },
    {
      topic: 'JVM & Garbage Collection',
      difficulty: 'Facile',
      question: "Quel paramètre de ligne de commande JVM définit la taille maximale de la mémoire allouée au tas (Heap) ?",
      choices: ["-Xmx", "-Xms", "-Xss", "-XX:MaxPermSize"],
      options: ["-Xmx", "-Xms", "-Xss", "-XX:MaxPermSize"],
      correctAnswer: 0,
      explanation: "`-Xmx` définit la taille maximale du Heap (ex: `-Xmx4g`), tandis que `-Xms` définit la taille initiale et `-Xss` la taille de pile par thread.",
      source: "Ancien examen"
    },
    {
      topic: 'JVM & Garbage Collection',
      difficulty: 'Moyen',
      question: "L'appel à `System.gc()` garantit-il le déclenchement immédiat et certain du ramasse-miettes en Java ?",
      choices: [
        "Non, c'est une simple suggestion faite à la JVM, qui reste totalement libre de l'ignorer selon sa politique interne",
        "Oui, il bloque le système jusqu'à ce que toute la mémoire soit vidée",
        "Oui, mais uniquement pour la jeune génération",
        "Oui, si la classe implémente Serializable"
      ],
      options: [
        "Non, c'est une simple suggestion faite à la JVM, qui reste totalement libre de l'ignorer selon sa politique interne",
        "Oui, il bloque le système jusqu'à ce que toute la mémoire soit vidée",
      ...
      correctAnswer: 0,
      explanation: "`System.gc()` ne fait qu'émettre un souhait auprès de la machine virtuelle. Rien ne garantit son exécution immédiate.",
      source: "Ancien examen"
    }
  ];
