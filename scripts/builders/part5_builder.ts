...
export function buildPart5Questions(): Question[] {
  const qList: Omit<Question, 'id' | 'part'>[] = [
    // 1. Processus & Threads (1-10)
    {
    ...
    },
    {
      ...
      choices: ["Le Tourniquet (Round Robin - RR)", "Le Premier Arrivé Premier Servi (FCFS)", "Le Plus Court Travail d'Abord (SJF)", "L'Ordonnancement par priorité statique"],
      options: ["Le Tourniquet (Round Robin - RR)", "Le Premier Arrivé Premier Servi (FCFS)", "Le Plus Court Travail d'Abord (SJF)", "L'Ordonnancement par priorité statique"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["PID 1 (init ou systemd)", "PID 0", "PID 100", "PID -1"],
      options: ["PID 1 (init ou systemd)", "PID 0", "PID 100", "PID -1"],
      correctAnswer: 0,
    ...
    // 2. Synchronisation et Interblocages (Deadlocks) (11-20)
    {
    ...
    },
    {
      ...
      choices: ["P (wait / down) et V (signal / up)", "Lock et Unlock", "Start et Stop", "Get et Put"],
      options: ["P (wait / down) et V (signal / up)", "Lock et Unlock", "Start et Stop", "Get et Put"],
      correctAnswer: 0,
    ...
    // 3. Gestion de la mémoire (21-30)
    {
      ...
      choices: ["La MMU (Memory Management Unit)", "L'ALU", "Le contrôleur DMA", "La FPU"],
      options: ["La MMU (Memory Management Unit)", "L'ALU", "Le contrôleur DMA", "La FPU"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["4 Ko (4096 octets)", "64 Ko", "1 Mo", "512 octets"],
      options: ["4 Ko (4096 octets)", "64 Ko", "1 Mo", "512 octets"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["LRU (Least Recently Used)", "FIFO (First In, First Out)", "LFU (Least Frequently Used)", "Algorithme optimal de Bélády"],
      options: ["LRU (Least Recently Used)", "FIFO (First In, First Out)", "LFU (Least Frequently Used)", "Algorithme optimal de Bélády"],
      correctAnswer: 0,
    ...
    // 4. Systèmes de fichiers & Inodes (31-40)
    {
    ...
    // 5. Commandes Linux & Bash (41-50)
    {
      ...
      choices: ["grep", "find", "locate", "cat"],
      options: ["grep", "find", "locate", "cat"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["find", "grep", "which", "whereis"],
      options: ["find", "grep", "which", "whereis"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["chmod", "chown", "chgrp", "setperm"],
      options: ["chmod", "chown", "chgrp", "setperm"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["top (ou htop)", "ps", "uptime", "free"],
      options: ["top (ou htop)", "ps", "uptime", "free"],
      correctAnswer: 0,
    ...
    // 6. Appels système & Signaux (51-60)
    {
      ...
      choices: ["fork()", "exec()", "clone()", "create()"],
      options: ["fork()", "exec()", "clone()", "create()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["execve() (ou famille exec)", "fork()", "system()", "load()"],
      options: ["execve() (ou famille exec)", "fork()", "system()", "load()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["wait() (ou waitpid())", "sleep()", "pause()", "halt()"],
      options: ["wait() (ou waitpid())", "sleep()", "pause()", "halt()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["SIGKILL (9) et SIGSTOP (19)", "SIGINT (2) et SIGTERM (15)", "SIGSEGV (11) et SIGFPE (8)", "SIGHUP (1) et SIGQUIT (3)"],
      options: ["SIGKILL (9) et SIGSTOP (19)", "SIGINT (2) et SIGTERM (15)", "SIGSEGV (11) et SIGFPE (8)", "SIGHUP (1) et SIGQUIT (3)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["SIGINT (Signal Interrupt)", "SIGKILL", "SIGTERM", "SIGTSTP"],
      options: ["SIGINT (Signal Interrupt)", "SIGKILL", "SIGTERM", "SIGTSTP"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["SIGTSTP (Terminal Stop)", "SIGQUIT", "SIGABRT", "SIGCONT"],
      options: ["SIGTSTP (Terminal Stop)", "SIGQUIT", "SIGABRT", "SIGCONT"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["SIGSEGV (Segmentation Fault)", "SIGILL", "SIGBUS", "SIGSYS"],
      options: ["SIGSEGV (Segmentation Fault)", "SIGILL", "SIGBUS", "SIGSYS"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["sigaction() (ou signal())", "setjmp()", "register_signal()", "catch_event()"],
      options: ["sigaction() (ou signal())", "setjmp()", "register_signal()", "catch_event()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Elle envoie le signal SIGTERM (15)", "Elle envoie SIGKILL (9)", "Elle envoie SIGINT (2)", "Elle redémarre le processus"],
      options: ["Elle envoie le signal SIGTERM (15)", "Elle envoie SIGKILL (9)", "Elle envoie SIGINT (2)", "Elle redémarre le processus"],
      correctAnswer: 0,
      explanation: "Par défaut, `kill` envoie SIGTERM (15), invitant le processus à s'arrêter proprement en sauvegardant ses données.",
      source: "Ancien examen"
    },

    // 7. Architecture du noyau (Noyau Monolithique vs Micro-noyau) (61-70)
    {
    ...
    },
    {
      ...
      choices: ["dmesg", "journalctl -k", "kernlog", "sysmsg"],
      options: ["dmesg", "journalctl -k", "kernlog", "sysmsg"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["systemctl enable service_name", "systemctl start service_name", "systemctl auto service_name", "systemctl boot service_name"],
      options: ["systemctl enable service_name", "systemctl start service_name", "systemctl auto service_name", "systemctl boot service_name"],
      correctAnswer: 0,
    ...
    // 8. Gestion des utilisateurs, permissions & sécurité (71-80)
    {
      ...
      choices: ["UID 0", "UID 1", "UID 1000", "UID -1"],
      options: ["UID 0", "UID 1", "UID 1000", "UID -1"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["/etc/passwd", "/etc/shadow", "/etc/users", "/etc/group"],
    ...
    },
    {
      ...
      choices: ["sudo", "su", "rootme", "admin"],
      options: ["sudo", "su", "rootme", "admin"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["chown", "chmod", "chgrp", "setuser"],
      options: ["chown", "chmod", "chgrp", "setuser"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["/etc/sudoers (édité avec visudo)", "/etc/hosts", "/etc/fstab", "/etc/resolv.conf"],
      options: ["/etc/sudoers (édité avec visudo)", "/etc/hosts", "/etc/fstab", "/etc/resolv.conf"],
      correctAnswer: 0,
    ...
    // 9. Pilotes, Périphériques & E/S (81-90)
    {
    ...
    },
    {
      ...
      choices: ["sync", "flush", "commit", "save"],
      options: ["sync", "flush", "commit", "save"],
      correctAnswer: 0,
    ...
    // 10. Virtualisation, Conteneurs & Concepts avancés (91-100)
    {
    ...
    },
    {
      ...
      choices: ["chroot", "isolate", "cage", "sandbox"],
      options: ["chroot", "isolate", "cage", "sandbox"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["cron (via crontab)", "atd", "timed", "scheduler"],
      options: ["cron (via crontab)", "atd", "timed", "scheduler"],
      correctAnswer: 0,
    ...
    },
    {
      topic: 'Virtualisation & Conteneurs',
      difficulty: 'Difficile',
      question: "Qu'est-ce qu'un système de fichiers Union (comme OverlayFS utilisé par Docker) ?",
      choices: [
        "Un système de fichiers capable de superposer plusieurs répertoires en une unique vue fusionnée, permettant d'empiler des couches d'images en lecture seule sous une fine couche d'écriture supérieure",
        "Une union de deux disques durs en RAID 0",
        "Un protocole de partage de fichiers entre plusieurs pays",
        "Un système de fichiers réservé aux clusters bancaires"
      ],
      options: [
        "Un système de fichiers capable de superposer plusieurs répertoires en une unique vue fusionnée, permettant d'empiler des couches d'images en lecture seule sous une fine couche d'écriture supérieure",
        "Une union de deux disques durs en RAID 0",
      ...
      correctAnswer: 0,
      explanation: "OverlayFS combine une couche `lowerdir` (lecture seule, image de conteneur) et une couche `upperdir` (écriture, conteneur actif), rendant le lancement d'instances instantané.",
      source: "Ancien examen"
    }
  ];
