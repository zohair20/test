...
export function buildPart3Questions(): Question[] {
  const qList: Omit<Question, 'id' | 'part'>[] = [
    // 1. Types de données, variables & opérateurs en C (1-10)
    {
      ...
      choices: ["sizeof", "lengthof", "size", "bytes"],
      options: ["sizeof", "lengthof", "size", "bytes"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["2", "2.5", "3", "Erreur de compilation"],
      options: ["2", "2.5", "3", "Erreur de compilation"],
      correctAnswer: 0,
    ...
    // 2. Structures de contrôle (11-20)
    {
    ...
    },
    {
      ...
      choices: ["3 fois (pour i=0, i=2, i=4)", "5 fois", "2 fois", "Infini"],
      options: ["3 fois (pour i=0, i=2, i=4)", "5 fois", "2 fois", "Infini"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["default:", "else:", "otherwise:", "fallback:"],
    ...
    },
    {
      ...
      choices: ["goto", "jump", "branch", "skip"],
      options: ["goto", "jump", "branch", "skip"],
      correctAnswer: 0,
    ...
    // 3. Fonctions, paramètres & récursivité (21-30)
    {
      topic: 'Fonctions C',
      difficulty: 'Facile',
    ...
    },
    {
      ...
      choices: ["0 (ou EXIT_SUCCESS)", "1", "-1", "255"],
      options: ["0 (ou EXIT_SUCCESS)", "1", "-1", "255"],
      correctAnswer: 0,
    ...
    // 4. Pointeurs & Arithmétique des pointeurs (31-40)
    {
      topic: 'Pointeurs C',
      difficulty: 'Facile',
    ...
    },
    {
      ...
      choices: ["L'opérateur esperluette (&)", "L'opérateur astérisque (*)", "L'opérateur flèche (->)", "L'opérateur tilde (~)"],
      options: ["L'opérateur esperluette (&)", "L'opérateur astérisque (*)", "L'opérateur flèche (->)", "L'opérateur tilde (~)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["L'opérateur astérisque (*)", "L'opérateur esperluette (&)", "L'opérateur point (.)", "L'opérateur dièse (#)"],
      options: ["L'opérateur astérisque (*)", "L'opérateur esperluette (&)", "L'opérateur point (.)", "L'opérateur dièse (#)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["4 octets", "1 octet", "8 octets", "2 octets"],
      options: ["4 octets", "1 octet", "8 octets", "2 octets"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Une constante entière de valeur 0 convertie en pointeur (`(void*)0`)", "Une chaîne de caractères vide", "L'adresse -1", "Une fonction système"],
      options: ["Une constante entière de valeur 0 convertie en pointeur (`(void*)0`)", "Une chaîne de caractères vide", "L'adresse -1", "Une fonction système"],
      correctAnswer: 0,
    ...
    // 5. Tableaux & Chaînes (41-50)
    {
      ...
      choices: ["Le caractère nul '\\0'", "Le caractère retour chariot '\\n'", "Le caractère espace ' '", "Le caractère point '.'"],
      options: ["Le caractère nul '\\0'", "Le caractère retour chariot '\\n'", "Le caractère espace ' '", "Le caractère point '.'"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["8 octets (7 caractères + 1 octet pour le '\\0')", "7 octets", "6 octets", "14 octets"],
      options: ["8 octets (7 caractères + 1 octet pour le '\\0')", "7 octets", "6 octets", "14 octets"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["strlen()", "sizeof()", "strlength()", "length()"],
    ...
    },
    {
      ...
      choices: ["strcpy", "strcmp", "strcat", "strchr"],
      options: ["strcpy", "strcmp", "strcat", "strchr"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["0", "1", "-1", "Dépend du compilateur"],
      options: ["0", "1", "-1", "Dépend du compilateur"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["strcat()", "strcpy()", "strappend()", "strjoin()"],
      options: ["strcat()", "strcpy()", "strappend()", "strjoin()"],
      correctAnswer: 0,
    ...
    // 6. Allocation dynamique de mémoire (51-60)
    {
      ...
      choices: ["<stdlib.h>", "<stdio.h>", "<memory.h>", "<string.h>"],
    ...
    },
    {
      ...
      choices: ["Le tas (Heap)", "La pile (Stack)", "Le segment de texte (Code)", "Le segment de données initialisées (Data)"],
      options: ["Le tas (Heap)", "La pile (Stack)", "Le segment de texte (Code)", "Le segment de données initialisées (Data)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Le pointeur NULL", "Une exception", "La valeur -1", "Un pointeur vers l'adresse 0xFFFFFFFF"],
      options: ["Le pointeur NULL", "Une exception", "La valeur -1", "Un pointeur vers l'adresse 0xFFFFFFFF"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["Valgrind (Memcheck)", "GDB", "Make", "GCC"],
      options: ["Valgrind (Memcheck)", "GDB", "Make", "GCC"],
      correctAnswer: 0,
    ...
    // 7. Structures, Unions & Enums (61-70)
    {
      ...
      choices: ["L'opérateur point (.)", "L'opérateur flèche (->)", "L'opérateur deux-points (::)", "L'opérateur dièse (#)"],
      options: ["L'opérateur point (.)", "L'opérateur flèche (->)", "L'opérateur deux-points (::)", "L'opérateur dièse (#)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["typedef", "alias", "define", "using"],
      options: ["typedef", "alias", "define", "using"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["NULL", "-1", "EOF", "0"],
      options: ["NULL", "-1", "EOF", "0"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["fclose()", "close()", "file_close()", "fflush()"],
      options: ["fclose()", "close()", "file_close()", "fflush()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["EOF (généralement -1)", "NULL", "0", "'\\0'"],
      options: ["EOF (généralement -1)", "NULL", "0", "'\\0'"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["fseek()", "rewind()", "ftell()", "fmove()"],
      options: ["fseek()", "rewind()", "ftell()", "fmove()"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["ftell()", "fpos()", "fseek()", "fgetpos()"],
    ...
    // 9. Préprocesseur C (81-90)
    {
      ...
      choices: ["Le dièse (#)", "Le dollar ($)", "L'arobase (@)", "La double barre (//)"],
      options: ["Le dièse (#)", "Le dollar ($)", "L'arobase (@)", "La double barre (//)"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["__LINE__", "__FILE__", "__DATE__", "__TIME__"],
    ...
    },
    {
      ...
      choices: ["__FILE__", "__PATH__", "__SOURCE__", "__NAME__"],
      options: ["__FILE__", "__PATH__", "__SOURCE__", "__NAME__"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["#undef", "#delete", "#remove", "#clear"],
    ...
    // 10. Portée, Compilation & Makefiles (91-100)
    {
    ...
    },
    {
      ...
      choices: ["extern", "import", "public", "global"],
      options: ["extern", "import", "public", "global"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      choices: ["-Wall -Wextra", "-O3", "-g", "-c"],
      options: ["-Wall -Wextra", "-O3", "-g", "-c"],
      correctAnswer: 0,
    ...
    },
    {
      topic: 'Portée & Compilation C',
      difficulty: 'Facile',
      question: "Quelle option de GCC produit uniquement le fichier objet compilé (`.o`) sans appeler l'éditeur de liens (Linker) ?",
      choices: ["-c", "-o", "-S", "-E"],
      options: ["-c", "-o", "-S", "-E"],
      correctAnswer: 0,
      explanation: "`gcc -c fichier.c` compile le code source en code machine objet `fichier.o` sans créer l'exécutable final.",
      source: "Ancien examen"
    },
    {
      topic: 'Portée & Compilation C',
      difficulty: 'Moyen',
      question: "Dans un fichier `Makefile`, quel caractère d'indentation est strictement obligatoire au début de chaque ligne de commande d'une recette ?",
      choices: ["Une tabulation (Tab)", "4 espaces", "2 espaces", "Un tiret (-)"],
      options: ["Une tabulation (Tab)", "4 espaces", "2 espaces", "Un tiret (-)"],
      correctAnswer: 0,
      explanation: "Dans la syntaxe historique des Makefiles GNU/Unix, chaque ligne d'action d'une règle DOIT impérativement commencer par une tabulation ('\\t'). L'utilisation d'espaces provoque une erreur fatale.",
      source: "Ancien examen"
    },
    {
      topic: 'Portée & Compilation C',
      difficulty: 'Difficile',
      question: "Dans un Makefile, que représente la variable automatique `$@` ?",
      choices: [
        "Le nom de la cible (target) de la règle courante",
      ...
      correctAnswer: 0,
      explanation: "Dans Make : `$@` désigne la cible, `$<` désigne le premier prérequis, et `$^` la liste de tous les prérequis.",
      source: "Ancien examen"
    },
    {
      topic: 'Portée & Compilation C',
      difficulty: 'Moyen',
      question: "Quel rôle joue l'éditeur de liens (Linker, ex: `ld`) dans la chaîne de compilation C ?",
      choices: [
        "Il résout les références de symboles entre les différents fichiers objets (`.o`) et les bibliothèques (`.a`, `.so`), et génère le fichier binaire exécutable final",
        "Il traduit le code C en assembleur",
        "Il vérifie la syntaxe des accolades",
      ...
      correctAnswer: 0,
      explanation: "L'éditeur de liens assemble les fichiers objets intermédiaires et associe les appels de fonctions à leurs définitions concrètes pour créer l'exécutable.",
      source: "Ancien examen"
    },
    {
      topic: 'Portée & Compilation C',
      difficulty: 'Difficile',
      question: "Que se produit-il lors d'une tentative de modification d'un littéral de chaîne comme `char *str = \"Hello\"; str[0] = 'h';` ?",
      choices: [
        "Un plantage par Segmentation Fault car les chaînes littérales sont stockées dans le segment de mémoire en lecture seule (.rodata)",
        "La chaîne devient \"hello\" sans problème",
        "La variable est convertie en tableau dynamique",
        "Un avertissement à la compilation sans erreur à l'exécution"
      ],
      options: [
        "Un plantage par Segmentation Fault car les chaînes littérales sont stockées dans le segment de mémoire en lecture seule (.rodata)",
        "La chaîne devient \"hello\" sans problème",
      ...
      correctAnswer: 0,
      explanation: "Les littéraux de chaînes entre guillemets sont placés en zone mémoire protégée en lecture seule (`.rodata`). Tenter d'écrire dedans provoque un crash immédiat (Segmentation Fault). Pour un tableau modifiable, il faut déclarer `char str[] = \"Hello\";`.",
      source: "Ancien examen"
    }
  ];
