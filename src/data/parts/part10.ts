...
export const PART_10_QUESTIONS: Question[] = [
  {
    "id": "p10-q1",
    "part": 10,
  ...
  },
  {
    ...
    "options": [
      "Le complément à deux (Two's complement)",
      "Le complément à un",
      "La notation signe et valeur absolue",
      "Le code Gray"
    ],
    "choices": [
      "Le complément à deux (Two's complement)",
  ...
  },
  {
    ...
    "options": [
      "Le Service (ClusterIP, NodePort ou LoadBalancer)",
      "Le ConfigMap",
      "Le Volume",
      "Le DaemonSet"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "La Sigmoïde standard",
      "La Tangente Hyperbolique (Tanh)",
      "La fonction escalier de Heaviside"
    ],
    "choices": [
      "ReLU (Rectified Linear Unit : f(x) = max(0, x))",
      "La Sigmoïde standard",
